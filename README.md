...
## 1. Desafio
Esse projeto foi desenvolvido em dupla durante o bootcamp da Laboratoria que trouxe como proposta desenvolver com um app para gerenciamento de pedidos em uma hamburgueria com uma interface para tablets e utilizando o React.JS.
...
:octocat: Projeto desenvolvido com :heart: por:
